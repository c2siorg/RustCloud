...
async fn delete_key(client: &Client, custom_key_store_id: String) -> Result<(), Error> {
...
async fn describe_key(client: &Client, key_id: String, grant_tokens: Option<Vec<String>>) -> Result<(), Error> {
...
async fn put_key_policy(client: &Client, key_id: String, policy_name: String, policy: String, bypass_policy_lockout_safety_check: Option<bool>) -> Result<(), Error> {
...
async fn update(client: &Client, key_id: String, description: Option<String>) -> Result<(), Error> {
