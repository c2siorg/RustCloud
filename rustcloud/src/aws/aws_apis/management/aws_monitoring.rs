...
async fn delete_alarm(client: &Client, alarm_name: &String) -> Result<(), Error> {
...
async fn get_metric_data(client: &Client, metric_data_queries:Option<Vec<MetricDataQuery>>,start_time: Option<DateTime>,end_time: Option<DateTime>,next_token: Option<String>,scan_by: Option<ScanBy>,  max_datapoints: Option<i32>,label_options: Option<LabelOptions>) -> Result<(), Error> {
...
async fn list_alarms(client: &Client) -> Result<(),Error> {
